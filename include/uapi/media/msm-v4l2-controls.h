...
#define V4L2_CID_MPEG_VIDC_VIDEO_FRAME_RATE	\
		(V4L2_CID_MPEG_MSM_VIDC_BASE + 8)
#define V4L2_CID_MPEG_VIDC_VIDEO_IDR_PERIOD	\
		(V4L2_CID_MPEG_MSM_VIDC_BASE + 9)
#define V4L2_CID_MPEG_VIDC_VIDEO_NUM_P_FRAMES	\
		(V4L2_CID_MPEG_MSM_VIDC_BASE + 10)
#define V4L2_CID_MPEG_VIDC_VIDEO_NUM_B_FRAMES	\
		(V4L2_CID_MPEG_MSM_VIDC_BASE + 11)
#define V4L2_CID_MPEG_VIDC_VIDEO_REQUEST_IFRAME	\
...
#define V4L2_CID_MPEG_VIDC_VIDEO_ROTATION	\
...
#define V4L2_CID_MPEG_VIDC_VIDEO_AIR_MBS	\
		(V4L2_CID_MPEG_MSM_VIDC_BASE + 17)
#define V4L2_CID_MPEG_VIDC_VIDEO_AIR_REF	\
		(V4L2_CID_MPEG_MSM_VIDC_BASE + 18)
#define V4L2_CID_MPEG_VIDC_VIDEO_CIR_MBS	\
...
#define V4L2_CID_MPEG_VIDC_VIDEO_H263_LEVEL	\
...
#define V4L2_CID_MPEG_VIDC_VIDEO_VP8_MIN_QP	\
		(V4L2_CID_MPEG_MSM_VIDC_BASE + 44)
#define V4L2_CID_MPEG_VIDC_VIDEO_VP8_MAX_QP	\
